...
app.run([
  ...
  function ($rootScope, $location) {
    ...
    $rootScope.submitSearch = function (event) {
      ...
      if ($rootScope.keyword && $rootScope.keyword.trim() !== "") {
...
app.controller("DatLichController", function ($scope, $http) {
  ...
  $scope.xacNhanDatLich = function () {
    ...
    $http.post("/api/khachhang/lichhen", lichHenData).then(
      function (res) {
...
app.controller("DangKiController", [
  "$scope",
  "$http",
  function ($scope, $http) {
    $scope.title = "Đăng Kí";
    ...
    $scope.dangKyKhachHang = function () {
      ...
      if ($scope.dangKyForm.$valid) {
        ...
        // Gửi yêu cầu đăng ký
        $http.post("/api/dangky", khachHangDTO).then(
          function (response) {
            $scope.success = true;
...
app.controller("QuenMatKhauController", function ($scope, $http) {
  ...
  $scope.submitForgotPassword = function () {
    $http
      .post("/api/khachhang/forgot-password", { email: $scope.form.email })
...
app.controller("LichSuSuaChuaController", function ($scope, $rootScope, $http) {
  ...
  $scope.batDau = "";
  $scope.ketThuc = "";
  $http.get("/api/khachhang/lichsu").then(
    function (response) {
...
app.controller("PhieuDichVuController", function ($scope, $http, $routeParams) {
  ...
  $http
    .get("/api/khachhang/phieudichvu?idPhieuDichVu=" + idPhieuDichVu)
    .then(function (response) {
...
app.controller("DichVuController", function ($scope, $http, $routeParams) {
  ...
  var idPhieuDichVu = $routeParams.idPhieuDichVu;
  $http
    .get("/api/khachhang/chitiet?idPhieuDichVu=" + idPhieuDichVu)
    .then(function (response) {
...
app.controller("TinhTrangXeController", function ($scope, $http, $routeParams) {
  ...
  $http
    .get("/api/khachhang/tinhtrangxe?idPhieuGNX=" + idPhieuGNX)
    .then(function (response) {
...
app.controller("TimKiemController", function ($scope, $http, $routeParams) {
  ...
  if ($scope.keyword.trim() !== "") {
    $http
      .get("/api/khachhang/timkiem?keyword=" + encodeURIComponent($scope.keyword))
      .then(function (response) {
...
app.controller("DoiMatKhauController", function ($scope, $http, $location, AuthService) {
  ...
  $scope.changePassword = function () {
    $http.post("/api/khachhang/doimatkhau", $scope.matKhauData).then(
      function (res) {
